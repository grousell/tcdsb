...
tcdsb_report_template_pdf <- function(report_name){
  ...
  download.file("https://github.com/grousell/tcdsb/blob/master/images/r_a_footer.png",
                destfile = "images/r_a_footer.png",
                mode = "wb")

  download.file("https://github.com/grousell/tcdsb/blob/master/images/tcdsb_logo_BW.png",
