...
```{r basic_plot, echo=TRUE, warning=FALSE, fig.width=4, fig.height=4}
library(tidyverse)
library(tcdsb)
...
```{r themed_plot,echo=TRUE, warning=FALSE, fig.width=4, fig.height=4}
...
```{r themed_plot2,echo=TRUE, warning=FALSE, fig.width=4, fig.height=4}
...
```{r project_setup,echo=TRUE, warning=FALSE}
